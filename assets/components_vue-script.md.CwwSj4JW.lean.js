import{_ as m,d as y,B as E,c as g,o,a2 as F,G as l,j as i,a3 as u,w as k,a as s,t as C,F as c,p as e,k as b}from"./chunks/framework.1hhD_utJ.js";const v=y({name:"InputDemo",setup(){const a=e(),n=e();function t(){n.value=a.value}return{input:a,content:n,onSubmit:t}}}),x={style:{"margin-top":"16px"}};function f(a,n,t,h,B,p){const r=E("xl-button");return o(),g(c,null,[F(i("input",{class:"input",type:"text","onUpdate:modelValue":n[0]||(n[0]=d=>a.input=d)},null,512),[[u,a.input]]),l(r,{type:"primary",onClick:a.onSubmit},{default:k(()=>n[1]||(n[1]=[s("提交")])),_:1},8,["onClick"]),i("div",x,"输出内容："+C(a.content),1)],64)}const D=m(v,[["render",f],["__scopeId","data-v-f7a500b5"]]),A={style:{"margin-top":"16px"}},S=y({__name:"vue-script.md.demo.500be8f8",setup(a){const n=e(),t=e();function h(){t.value=n.value}return(B,p)=>{const r=E("xl-button");return o(),g(c,null,[F(i("input",{class:"input",type:"text","onUpdate:modelValue":p[0]||(p[0]=d=>n.value=d)},null,512),[[u,n.value]]),l(r,{type:"primary",onClick:h},{default:k(()=>p[1]||(p[1]=[s("提交")])),_:1}),i("div",A,"输出内容："+C(t.value),1)],64)}}}),_=m(S,[["__scopeId","data-v-ccdad1a5"]]),I=y({setup(){const a=e(),n=e();function t(){n.value=a.value}return()=>l(c,null,[F(l("input",{class:"input input-tsx",type:"text","onUpdate:modelValue":h=>a.value=h},null),[[u,a.value]]),l(E("xl-button"),{type:"primary",onClick:t},{default:()=>[s("提交")]}),l("div",{style:"margin-top: 16px"},[s("输出内容："),n.value])])}}),$=JSON.parse('{"title":"Vue Script","description":"","frontmatter":{},"headers":[],"relativePath":"components/vue-script.md","filePath":"components/vue-script.md","lastUpdated":1742886431000}'),V={name:"components/vue-script.md"},j=Object.assign(V,{setup(a){return(n,t)=>{const h=E("demo");return o(),g("div",null,[t[3]||(t[3]=i("h1",{id:"vue-script",tabindex:"-1"},[s("Vue Script "),i("a",{class:"header-anchor",href:"#vue-script","aria-label":'Permalink to "Vue Script"'},"​")],-1)),t[4]||(t[4]=i("h2",{id:"基础用法",tabindex:"-1"},[s("基础用法 "),i("a",{class:"header-anchor",href:"#基础用法","aria-label":'Permalink to "基础用法"'},"​")],-1)),t[5]||(t[5]=i("p",null,"基础的按钮用法。",-1)),l(h,{customClass:"demoblock-custom",sourceCode:`<template>
...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"    </>)")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"  }")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"})")])])])],-1)])),default:k(()=>[l(b(I))]),_:1})])}}});export{$ as __pageData,j as default};
