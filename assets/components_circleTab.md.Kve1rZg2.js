...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"    }")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"script"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1)])),default:E(()=>[l(u)]),_:1}),a[4]||(a[4]=b('<p>:::</p><h2 id="attributes" tabindex="-1">Attributes <a class="header-anchor" href="#attributes" aria-label="Permalink to &quot;Attributes&quot;">​</a></h2><table tabindex="0"><thead><tr><th>参数</th><th>说明</th><th>类型</th><th>可选值</th><th>默认值</th></tr></thead><tbody><tr><td>tabs</td><td>子项</td><td>array</td><td>[]</td><td>-</td></tr><tr><td>activeKey</td><td>string</td><td>number</td><td>-</td><td></td></tr><tr><td>change</td><td>切换面板的回调</td><td>Function(activeKey) {}</td><td>-</td><td></td></tr></tbody></table>',3))])}}});export{C as __pageData,B as default};
